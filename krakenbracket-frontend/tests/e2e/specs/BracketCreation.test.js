...
describe("Tests the start and end date range", () => {
  ...
  it("Checks an end date before the start date", () => {
    ...
    cy.get(
      ".menuable__content__active > .v-picker > .v-picker__body > :nth-child(1) > .v-date-picker-table > table > tbody > :nth-child(2) > :nth-child(3) > .v-btn"
    ).click();

    cy.get("#input-53").click();
    cy.get(
      ".menuable__content__active > .v-picker > .v-picker__body > :nth-child(1) > .v-date-picker-table > table > tbody > :nth-child(2) > :nth-child(4) > .v-btn"
    ).click();
  });
});
...
describe("Create a bracket", () => {
  ...
  it("Fills the bracket form", () => {
    ...
    cy.get(
      "#list-item-70-0 > .v-list-item__content > .v-list-item__title"
    ).click();
